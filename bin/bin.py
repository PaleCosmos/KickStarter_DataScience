...
df_kick = load_data(FILE_INPUT)#.drop(['Unnamed: 0','Unnamed: 0.1'])
#print(df_kick.describe())
#print(df_kick.head(n=3))
...
#[0] and [1] is undefined.
X = df_trimmed.iloc[:,11:27] 
y = df_trimmed.iloc[:,27]
#X = df_trimmed.iloc[:,13:29] 
#y = df_trimmed.iloc[:,29]
print(df_trimmed.iloc[:,2:])
Xarr = X.values
yarr = y.values
